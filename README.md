...
3Vous pouvez démarrer MySQL ou PostgreSQL localement avec n’importe quel programme d’installation qui fonctionne pour votre système d’exploitation ou utiliser docker:

3docker run -e MYSQL_USER=Gest-Stock -e MYSQL_PASSWORD=Gest-Stock -e MYSQL_ROOT_PASSWORD=root -e MYSQL_DATABASE=Gest-Stock -p 3306:3306 mysql:8.0
ou
